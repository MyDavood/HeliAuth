...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function sendConfirmToTelegram($telegramId, $userId, $request)
        {
                        /** @var \Heli\Auth\HeliAuth $instance */
                        return $instance->sendConfirmToTelegram($telegramId, $userId, $request);
        }
                    /**
         * 
         *
        ...
        {
                        /** @var \Heli\Auth\HeliAuth $instance */
                        return $instance->isValidHash($hash);
        }
                    /**
         * 
         *
        ...
        {
                        /** @var \Heli\Auth\HeliAuth $instance */
                        return $instance->getUserId($hash);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function isApproved($hash)
        {
                        /** @var \Heli\Auth\HeliAuth $instance */
                        return $instance->isApproved($hash);
        }
...
namespace  { 
            ...
            class HeliAuth extends \Heli\Auth\HeliAuth {}
